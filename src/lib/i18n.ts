...
const tr = {
  ...
  "plan.trend": "Son 6 ay — aylık gider",
  "plan.trendDesc": "Her sütun o ayın toplam harcamasını gösterir; gelir bu grafiğe dahil değildir.",
...
const en: Record<keyof typeof tr, string> = {
  ...
  "plan.trend": "Last 6 months — monthly spending",
  "plan.trendDesc": "Each bar is that month's total spending; income is not included here.",
